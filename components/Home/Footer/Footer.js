...
const Footer = () => {
  ...
  return (
    <section id="contact" className={styles.main}>
     <link href="https://fonts.googleapis.com/css2?family=Pattaya&family=Patua+One&display=swap" rel="stylesheet"></link>
      <div style={LineStyle} > </div>
      <div className={styles.headingHolder}>
        <h1 data-aos="fade-in" data-aos-duration="1700" className={styles.headings}>
          Contact
        </h1>
      </div>
      <div className={styles.left}>
            ...
            <p data-aos="zoom-out" data-aos-duration="1000" className={styles.heading}>
            $peter coin has no association with FOX/Disney or the writers of Family Guy. <br></br>
